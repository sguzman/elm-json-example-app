...
get =
    ...
    prefName = (D.field "prefName")
    jobTitle = (D.field "jobTitle")
    department = (D.field "department")
    directReports = (D.field "directReports")
    division = (D.field "division")
    email = (D.field "email")
    location = (D.field "location")
    imgUrl = (D.field "imgUrl")
    reportsTo = (D.field "reportsTo")
    workPhone = (D.field "workPhone")
    ext = (D.field "ext")
    personalPhone = (D.field "personalPhone")
    id = (D.field "id")
    linkedInUrl = (D.field "linkedInUrl")
    twitterUrl = (D.field "twitterUrl")
    facebookUrl = (D.field "facebookUrl")
    instagramUrl = (D.field "instagramUrl")
    timeOff = (D.field "timeOff")
    timeOffIcon = (D.field "timeOffIcon")
    skype = (D.field "skype")
    pinterest = (D.field "pinterest")
    pronouns = (D.field "pronouns")
        }))
    }
